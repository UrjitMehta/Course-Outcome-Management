...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function insert(Request $req)
    {
        ...
        $member->cpassword=$req->input('cpassword');
        //$member->email_verified_at=$req->input('email_verified_at');

        $member->save();
        alert()->success('Registration Successfull', 'Login Into your Account');
