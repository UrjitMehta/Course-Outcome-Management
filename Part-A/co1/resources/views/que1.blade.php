                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Question1</li>
                            </ol>
                        </div>
                    </div>
                    @if (session('success'))
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Set Question 1</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <form action="{{route('home.save')}}" method="post" id="formFeild">
                                    ...
                                    <div class="card-body row">
                                        <div class="form-group col-sm-6">
                                            <label for="">Enter total number of Questions in Q-1<label
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label for="">Enter number of Co's in Q-1<label
                                                    style="color:red">*</label></label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
